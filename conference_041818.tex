...
\subsection{Conclusion}\label{SCM}
\begin{itemize}
In this paper, we applied the values of magnet and sticky defined by the National Tax survey to the use of stack overflow tags. The change in the interests of other engineers is very interesting to the engineers. The leaders of the project need better engineers and they want the engineers to stay forever. In order to know how to attract and keep outstanding engineers, we investigated using the tag usage rate. We find that:
\item %later!!!!!!
\item 
\item 
\item 
